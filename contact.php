...
$username = "u510162695_mcc_chat"; // your MySQL username
$password = "1Mcc_chat"; // your MySQL password
$dbname = "u510162695_mcc_chat"; // your database name
...
if (isset($_POST['save_edit'])) {
    ...
    foreach ($_POST as $key => $value) {
        if ($key != 'selected_table' && $key != 'id' && $key != 'save_edit') {
            $fields[] = "$key = ?";
            $values[] = $value;
        }
    }
...
if (isset($_POST['view_columns'])) {
    ...
    echo "<input type='text' name='id' id='id' required><br><br>";
