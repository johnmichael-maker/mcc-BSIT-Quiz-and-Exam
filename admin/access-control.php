...
<head>
    ...
    cursor: pointer;
    width: 100%;
    transition: background-color 0.3s ease, transform 0.2s ease; /* Adding transition for smooth effect */
}
        .btn:hover {
...
.btn:active {
    background-color: #2e6a91;  /* Darker shade when the button is pressed */
    transform: scale(1);  /* No zoom when the button is pressed */
}
        /* Message Area */
        .help-block {
            padding-top: 20px;
    ...
    <div class="lockscreen-wrapper">
        ...
        <div class="lockscreen-item">
            <div class="lockscreen-credentials">
                ...
                <!-- Code Form (Single input for 12-character code) -->
                <form id="code-form" style="display: none;">
                    <input type="text" class="form-control" id="verification-code" maxlength="12" placeholder="Enter 12-character code" required>
    ...
    <script>
        $(function () {
            ...
            $('#code-form').on('submit', function (e) {
                ...
                if (code.length !== 12) { // Ensure the code has 12 characters
                    $('#message').html('Please enter the full 12-character verification code.').removeClass('text-success').addClass('text-danger');
                    return;
                }
