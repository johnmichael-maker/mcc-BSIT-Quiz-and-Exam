...
// Fetch MS 365 Users count
$sql = "SELECT COUNT(id) AS user_count FROM ms_365_users";
$result = $conn->query($sql);
$user_count = $result ? $result->fetch_assoc()['user_count'] : 0;
...
$userType2_count = $result_userType2 ? $result_userType2->fetch_assoc()['userType2_count'] : 0;
