...
<div class="h-100-vh d-flex align-items-center justify-content-center background-image">
    ...
    <div class="container">
    <form name="login" class="m-auto" id="signup-card" method="POST" action="login.php">
            <div class="card">
                <div class="card-body">
                    ...
                    <input type="text" class="form-control my-2" placeholder="Enter Your Email " name="uname"required>
